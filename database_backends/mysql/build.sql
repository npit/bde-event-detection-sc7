...
CREATE TABLE IF NOT EXISTS blog_feeds (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), feed_url VARCHAR(255) NOT NULL, UNIQUE KEY(feed_url), etag VARCHAR(255) NULL, last_modified VARCHAR(255) NULL);
CREATE TABLE IF NOT EXISTS news_feeds  (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), feed_url VARCHAR(255) NOT NULL, UNIQUE KEY(feed_url), etag VARCHAR(255) NULL, last_modified VARCHAR(255) NULL);

CREATE TABLE IF NOT EXISTS blog_articles (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), entry_url VARCHAR(255) NOT NULL, UNIQUE KEY(entry_url), feed_url VARCHAR(255) NOT NULL, crawl_id BIGINT NOT NULL, raw_text MEDIUMTEXT, clean_text MEDIUMTEXT, analysed_text MEDIUMTEXT, published BIGINT, crawled BIGINT NOT NULL, language VARCHAR(2), title text);
CREATE TABLE IF NOT EXISTS news_articles (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), entry_url VARCHAR(255) NOT NULL, UNIQUE KEY(entry_url), feed_url VARCHAR(255) NOT NULL, crawl_id BIGINT NOT NULL, raw_text MEDIUMTEXT, clean_text MEDIUMTEXT, analysed_text MEDIUMTEXT, published BIGINT, crawled BIGINT NOT NULL, language VARCHAR(2), title text);
